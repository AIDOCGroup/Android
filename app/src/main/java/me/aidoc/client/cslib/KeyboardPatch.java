...
public class KeyboardPatch {
    ...
    public static com.gyf.barlibrary.KeyboardPatch patch(Activity activity) {
        return new com.gyf.barlibrary.KeyboardPatch(activity);
    }

    public static com.gyf.barlibrary.KeyboardPatch patch(Activity activity, View contentView) {
        return new com.gyf.barlibrary.KeyboardPatch(activity, contentView);
    }

    public static com.gyf.barlibrary.KeyboardPatch patch(Activity activity, Dialog dialog, String tag) {
        return new com.gyf.barlibrary.KeyboardPatch(activity, dialog, tag);
    }

    public static com.gyf.barlibrary.KeyboardPatch patch(Activity activity, Dialog dialog, String tag, View contentView) {
        return new com.gyf.barlibrary.KeyboardPatch(activity, dialog, tag, contentView);
    }

    protected static com.gyf.barlibrary.KeyboardPatch patch(Activity activity, Window window) {
        return new com.gyf.barlibrary.KeyboardPatch(activity, window);
    }
