...
public class BarParams implements Cloneable {
    ...
    public com.gyf.barlibrary.BarHide barHide = BarHide.FLAG_SHOW_BAR;  //隐藏Bar
    ...
    @Override
    protected com.gyf.barlibrary.BarParams clone() {
        com.gyf.barlibrary.BarParams barParams = null;
        try {
            barParams = (com.gyf.barlibrary.BarParams) super.clone();
