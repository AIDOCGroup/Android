package me.aidoc.client.custom.loading;
...
//        mIndicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, Color.WHITE);
        mIndicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, getResources().getColor(R.color.txt_gray_bbb));
