package me.aidoc.client.util.custom.wheel_picker;
...
public class PickerScrollView extends View {
    ...
    private int mColorText = 0x777777;
    ...
    private void init() {
        ...
        mMaxTextSize= DensityUtil.dp2px(mContext,24);
        mMinTextSize= DensityUtil.dp2px(mContext,14);
