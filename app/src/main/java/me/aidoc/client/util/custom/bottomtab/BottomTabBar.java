package me.aidoc.client.util.custom.bottomtab;
...
import me.aidoc.client.util.TintUtil;
...
public class BottomTabBar extends LinearLayout {
    ...
    //分割线背景
    private int dividerBackgroundColor = Color.parseColor("#E2E2E2");
    //BottomTabBar的整体背景
    ...
    private View getTabItemView(String name, Drawable drawable) {
        ...
        ImageView iv = (ImageView) view.findViewById(R.id.id_news_cover);
        ...
        TextView tv = (TextView) view.findViewById(R.id.tv_news_title);
        tv.setText(name);
